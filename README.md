...
- If you are using ``MATLAB``, please edit the file ``hw00.m`` and follow the instructions in the file.
- If you are using ``Python``, please edit the file ``hw00.py`` and follow the instructions in the file.
...
**Important: Any submission which fails to pass the sample tests will be counted as 0 pts directly.**
